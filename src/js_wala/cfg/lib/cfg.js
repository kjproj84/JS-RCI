...
define(function(require, exports) {
  ...
  function buildCFG(prog) {
   ...
   // console.log("ast.getPosition(prog)", ast.getPosition(prog));
    ...
    function buildStmtCFG(stmt, following, context, accu) {
      ...
      case 'ExpressionStatement':
        ...
        case 'CallExpression':
          ...
          if(stmt.expression.arguments) {
            for(var arg in stmt.expression.arguments){
        // console.log("FunctionExpression11 ", nd.expression.arguments[arg].type);
            if(stmt.expression.arguments[arg].type=='FunctionExpression'){
              //console.log("stmt.expression.arguments[arg].body[0]", stmt.expression.arguments[arg].body.body[0]);
                       addEdge(stmt,stmt.expression.arguments[arg].body.body[0]);
                buildStmtCFG(stmt.expression.arguments[arg].body, following, context, accu);
            // f(nd.expression.arguments[arg]);
            // f(ast.getAttribute(nd.expression.arguments[arg], 'fakeRoot'));
            //   buildFunctionCFG(stmt.expression.arguments[arg].body.body[0], context);
            // break;
            }
