...
module.exports = function(app){ 
    ...
    app.get('/api/ingredients/:id',  function(request, response, next){
    ...
    app.post('/api/ingredients',  function(request, response){
    ...
    app.put('/api/ingredients/:id',  function(request, response){
    ...
    app.delete('/api/ingredients/:id',  function(request, response){
