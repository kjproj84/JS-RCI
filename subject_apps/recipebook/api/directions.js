...
module.exports = function(app){ 
    ...
    app.get('/api/directions/:id', function(request, response, next){
    ...
    // POST /api/directions
    app.post('/api/directions', function(request, response){
    ...
    // PUT /api/recipes/:id
    app.put('/api/directions/:id', function(request, response){
    ...
    app.delete('/api/directions/:id',  function(request, response){
